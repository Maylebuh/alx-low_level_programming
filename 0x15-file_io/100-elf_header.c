...
/**
 * check_elf - checks if a file is an executive ELF file
 ...
 * @e_ident: an array containing the ELF osabi
 */
 ...
 * @e_ident: an array containing the ELF ABI
 */
 ...
 * @e_ident: an array containing the ELF point
 */
